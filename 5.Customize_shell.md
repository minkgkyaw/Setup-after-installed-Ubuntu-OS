...
>
> ထို့နော်က file ကို save ပါ။ 👉️ ([file save နည်းကြည့်ရန်](#nano-တွင်-file-save-နည်း)) 👈️
...
- `plugins=(git ...plugins)` ဆိုတဲ့နေရာကိုရှာပါ။
- `plugins` ထဲမှာ ဟိုးအပေါ်က ထည့်သွင်းထားတဲ့ **official oh-my-zsh plugins** တွေရဲ့နော်မှာ ယခု install လုပ်ထားတဲ့ **zsh plugins** တွေကို ထပ်ထည့်ပါမယ်။

</br>

```bash
plugins=(...plugins zsh-syntax-highlighting zsh-autosuggestions zsh-completions zsh-history-substring-search)
```
...
- လုပ်ပုံလုပ်နည်းက curent user နဲ့အတူတူပါပဲ။ sudo ထည့်ရတာလောက်ပဲကွာတာပါ။ ဒါကြောင့် အသေးစိတ်မပြောပြတော့ပါဘူး။
